                    ...
                    <div id="product">
                        <div class="primary-box row">
                            <div class="pb-left-column col-xs-12 col-sm-6">
                                ...
                                <div class="product-image">
                                    <div class="product-full">
                                        <img id="product-zoom" src='../<?php echo e($pro->Product_Image); ?>' data-zoom-image="<?php echo e($pro->Product_Image); ?>"/>
                                    </div>
                            ...
                            <div class="pb-right-column col-xs-12 col-sm-6">
                                <h1 class="product-name"><?php echo e($pro->Product_Name); ?></h1>
                                ...
                                <div class="product-price-group">
                                    <span class="price">$<?php echo e($pro->Product_Price); ?></span>
                                    <span class="old-price">$<?php echo e($pro->Product_PriceMarket); ?></span>
                                    <span class="discount">-30%</span>
                                </div>
                                <div class="info-orther">
                                    <p>Item Code: #<?php echo e($pro->Product_MID); ?></p>
                                    <p>Availability: <span class="in-stock"><?php echo e($pro->Product_InStock); ?></span></p>
                                    <p>Condition: New</p>
                                </div>
