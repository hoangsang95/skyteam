                            ...
                            <div class="pb-left-column col-xs-12 col-sm-6" style="margin-bottom:10px">
                                ...
                                <div class="product-image">
                                    <div class="product-full">
                                        <img id="product-zoom" src='<?php echo e($product->Product_Thumbnail); ?>' data-zoom-image="<?php echo e($product->Product_Thumbnail); ?>"/>
                                    </div>
                                    <div class="product-img-thumb" id="gallery_01">
                                        <ul class="owl-carousel" data-items="3" data-nav="true" data-dots="false" data-margin="20" data-loop="false">
                                            ...
                                            <li>
                                                <a href="#" data-image="<?php echo e($v); ?>" data-zoom-image="<?php echo e($v); ?>">
                                                    <img id="product-zoom"  src="<?php echo e($v); ?>" /> 
                                                </a>
                                            </li>
                        ...
                        <div class="page-product-box">
                            ...
                            <ul class="product-list owl-carousel" data-dots="false" data-loop="true" data-nav = "true" data-margin = "30" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":3},"1000":{"items":3}}'>
                                ...
                                <li>
                                        <div class="product-container">
                                                <div class="left-block">
                                                        <a href="san-phan-<?php echo e($product->Product_ID); ?>">
                                                                <img class="img-responsive" alt="product" src="<?php echo e($relate->Product_Thumbnail); ?>" />
                                                        </a>
                                                ...
                                                <div class="right-block">
                                                        <h5 class="product-name"><a href="#"><?php echo e($relate->Product_Name); ?></a></h5>
                                                        <div class="product-star">
                                                                <i class="fa fa-star"></i>
                                                                <i class="fa fa-star"></i>
                                                                <i class="fa fa-star"></i>
